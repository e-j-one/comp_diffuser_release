...
base = {
    'dataset': "humanoidmaze-medium-navigate-v0",
    ...
    'plan': {
        ...
        'n_act_per_waypnt': 1,
        'is_replan': 'ada_dist',
        'repl_ada_dist_cfg': dict(max_n_repl=10, thres=10, type='m_2', ada_dist_minus_n_wp=300, cond_2_extra=150, used_idxs=(0,1)),
        'inv_model_path': 'logs/humanoidmaze-medium-navigate-v0/diffusion/og_humMnav_Me_o69d_g69d_invdyn_h80_dm5_dout02',
        'inv_epoch': 'latest',
    },
