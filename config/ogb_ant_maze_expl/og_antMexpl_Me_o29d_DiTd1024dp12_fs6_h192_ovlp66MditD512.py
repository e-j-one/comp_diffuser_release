...
base = {
    'dataset': "antmaze-medium-explore-v0",
    ...
    'diffusion': {
        ...
        'trainer_cls': 'ogb_task.ogb_maze_v1.ogb_stgl_sml_training_v1.OgB_Stgl_Sml_Trainer_v1',
        'step_start_ema': 0,
        'update_ema_every': 1,
        'trainer_dict': dict(
            optim_type='adamw',
        ...
        ## dataset
        'loader': 'datasets.ogb_dset.OgB_SeqDataset_V1',
    ...
    'plan': {
        ...
        'n_act_per_waypnt': 1,
        'is_replan': 'ada_dist',
        'repl_ada_dist_cfg': dict(max_n_repl=10, thres=2, type='m_2', ada_dist_minus_n_wp=0, cond_2_extra=150, used_idxs=(0,1)),
        'inv_model_path': 'logs/antmaze-medium-explore-v0/diffusion/og_antMexpl_Me_o29d_g29d_invdyn_h12',
        'inv_epoch': 'latest',
    },
