...
ovlp_model_config = dict(
    ...
    depth=8, num_heads=4, mlp_ratio=4.0,
    tjti_enc_config=dict(
        frame_stack=6, w_init_type='no',),
)

di_tr_model_config=dict(
    hidden_size=512, depth=16, num_heads=8, mlp_ratio=4.0,
...
base = {
    ...
    'diffusion': {
        ...
        'trainer_dict': dict(
            ...
            # path_resume='set to the Path to the model checkpoint if need resume',
        ),
